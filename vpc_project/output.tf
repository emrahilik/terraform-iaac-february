...
output "private_Subnets" {
  value = [
        ...
        "${aws_subnet.private2.id}        ${aws_subnet.private2.cidr_block}     ${aws_subnet.private1.availability_zone }",
        "${aws_subnet.private3.id}        ${aws_subnet.private3.cidr_block}     ${aws_subnet.private1.availability_zone }"
    ]
}
